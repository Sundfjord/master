...
class Auth extends CI_Controller
{
			...
			if ($this->form_validation->run()) {								// validation ok
				if (!is_null($data = $this->tank_auth->create_user(
						...
						$this->form_validation->set_value('email'),
                                                $this->form_validation->set_value('group_id'),
						$this->form_validation->set_value('password'),
	...
	function _send_email($type, $email, &$data)
	{
		...
		// For testing purposes, we send all emails to self. Once live, replace with comment below
                $this->email->to($this->config->item('test_recipient_email', 'tank_auth')); //$this->email->to($email);
