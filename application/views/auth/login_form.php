...
<div id="content">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-lg-4 col-xs-offset-1 col-sm-offset-3 col-lg-offset-4">
            <h1>rockEnroll</h1>
            </div>
        </div>
            <div class="row">
                <div id="box" class="col-xs-10 col-sm-6 col-lg-4 col-xs-offset-1 col-sm-offset-3 col-lg-offset-4">
                    ...
                    <form role="form">
                        ...
                        <div class="form-group">
                            <?php echo form_submit('submit', 'Login', 'class="login btn btn-lg btn-info"'); ?>
                        </div>
                                <?php echo form_close(); ?>
                </div>
            </div>
