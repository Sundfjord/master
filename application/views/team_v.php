    ...
    <div id="team_content" class="tab-content">
            ...
            <div id="stats_table">
                <div class='row'>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4 ">
                        <div id="box">
                            <p>In the table, you can see an overview over who attended the most events in a certain period of time. Just pick your date range in the picker over the table, and rockEnroll will do the rest.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tab-pane fade" id="manage_squad">
            ...
            <div id="add_people_accordion" class="collapse">
                <div class='info'><p class='bg-info'><span class='glyphicon glyphicon-warning-sign'></span>If a player or coach can't be added to the team, it means he/she is already on your team, or have reached the limit of three teams.</p></div>
                <div class="row">
                    <?php if (empty($players)) {?>
                        <div class="col-sm-6">
                            <h2 class='white'>Apparently, there are no players. </h2>
                            <p class='white'>Ask your players to create a profile in order to start rollin'.</p>
                        </div>
                    <?php } else {?>
                        <div class="col-sm-6">
                            <div id="playersearch">
                                <h4 class="white">Player database</h4>
                                ...
                                <table id="player_table" class="table table-striped table-bordered dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="left"><input type="checkbox" name="players[]" id="checktest" value="<?php echo $p['id'];?>" <?php if(in_array($p['id'], $teamlist) || $p['teamcount'] >= 3) {echo "disabled='disabled'";}?> /> </td>
                ...
                <?php if (empty($coaches)) {?>
                        <div class="col-sm-6">
                            <h2 class='white'>Apparently, there are no coaches. </h2>
                            <p class='white'>Ask your coaching colleagues to create a profile in order to start rollin'.</p>
                        </div>
                    <?php } else {?>
                <div class="col-sm-6">
                    <div id="coachsearch">
                        <h4 class="white">Coach database</h4>
                        <table id="coach_table" class="table table-striped table-bordered dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="left"><input type="checkbox" name="coaches[]" id="coachtest" value="<?php echo $c['id'];?>" <?php if(in_array($c['id'], $coachlist) || $c['teamcount'] >= 3) {echo "disabled='disabled'";}?> /> </td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <input id="add_to_statistics" type="checkbox" name="add_to_statistics" checked> Add attendance for this event to statistics
                    </div>
                        ...
                        <?php echo '<div id="collapse' . $row['id'] . '" class="panel-collapse collapse">' ;?>
                            ...
                            <form id="edit_event_form" action="" method="post">
                                ...
                                <div class="form-group" id="error_edit">
                                    ...
                                    <label class='control-label' for="edited_eventname">Event name</label>
                                ...
                                <div class="form-group" id="error2_edit">
                                    ...
                                    <label class='control-label' for="edited_eventdesc">Event description</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-6" id="error3_edit">
                                        ...
                                        <label class='control-label' for="edited_start_time">Start time</label>
                                    ...
                                    <div class="col-xs-6" id="error4_edit">
                                        ...
                                        <label class='control-label' for="edited_end_time">End time</label>
                                ...
                                <div class="form-group" id="error5_edit">
                                    ...
                                    <label class='control-label' for="edited_location">Location</label>
                                ...
                                <div>
                                    <input id="edited_add_to_statistics" type="checkbox" name="edited_add_to_statistics" <?php if($row['add_to_statistics'] == 1) {echo 'checked';} ?> > Add attendance for this event to statistics
                                </div>
        ...
        <div class="modal-content">
            ...
            <form id="edit_episode_form" action="" method="post">
                ...
                <div class="form-group" id="error_editEp">
                    ...
                    <label for="edited_episodeName">Name</label>
                ...
                <div class="form-group" id="error2_editEp">
                    ...
                    <label for="edited_episodeDesc">Description</label>
                ...
                <div class="form-group" id="error3_editEp">
                    ...
                    <label for="edited_episodeDate">Date</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-6" id="error4_editEp">
                        ...
                        <label for="edited_episodeStartTime">Start time</label>
                    ...
                    <div class="col-xs-6" id="error5_editEp">
                        ...
                        <label for="edited_episodeEndTime">End time</label>
                ...
                <div class="form-group" id="error6_editEp">
                    ...
                    <label for="edited_episodeLocation">Location</label>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger" id="deleteepisodesubmit" type="button">Yeah, let it burn!</button>
